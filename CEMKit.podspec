#
#  Be sure to run `pod spec lint CEMKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of CEMKit in Markdown format.
  ...
  s.source       = { :git => "https://github.com/cemolcay/CEMKit.git", :tag => "0.0.1" }
